...
function App() {
  ...
  const handleContactSubmit = async (event) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      setContactStatus(
        "Email service is not configured yet. Add EmailJS keys to your .env file first."
      );
      return;
    }
    ...
    try {
      ...
      setContactStatus("Message sent successfully. Check your email inbox.");
    } catch (error) {
      setContactStatus("Message could not be sent. Check your EmailJS settings.");
    } finally {
      setIsSending(false);
    }
  };
  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="/New%20folder/majid.jpeg" alt="Majid Ali" className="w-10 h-10 rounded-md object-cover" />
              <q>Build secure, intelligent systems.</q>
            </div>
          ...
          <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
              <ProfileCard
                ...
                status="Pakistan"
                contactText="Connect"
                avatarUrl="/New%20folder/majid.jpeg"
                showUserInfo={true}
                enableTilt={true}
        ...
        {/* tentang */}
        <div className="mt-15 mx-auto w-full max-w-[1600px] rounded-3xl border-[5px] border-violet-500/40 shadow-[0_0_30px_rgba(168,85,247,0.4)] bg-linear-to-br from-[#0a0a0a] via-[#111111] to-[#1a1a1a] p-6" id="about">
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  <div>
                    <h1 className="text-3xl md:text-4xl mb-1">
                      03<span className="text-violet-500">+</span>
                    </h1>
                    <p>Featured Projects</p>
                  </div>
                  <div>
                    <h1 className="text-3xl md:text-4xl mb-1">
                      04<span className="text-violet-500">+</span>
                    </h1>
                    <p>Core Languages</p>
                  </div>
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      05<span className="text-violet-500">+</span>
                    </h1>
                    <p>Focus Areas</p>
                  </div>
                </div>
                ...
                <ShinyText
                  text="Secure by design. Curious by nature."
                  disabled={false}
                  speed={3}
            ...
            <div className="basis-full md:basis-5/12 pl-0 md:pl-8 overflow-hidden max-w-full flex justify-center items-center">
              <img
                src="/New%20folder/majid.jpeg"
                alt="Majid Ali"
                className="w-full max-w-md rounded-3xl object-cover shadow-2xl border border-white/10"
              />
            </div>
          </div>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="text-center">
                    <button
                      type="submit"
                      disabled={isSending}
                      className="font-semibold bg-[#1a1a1a] p-4 px-6 rounded-full w-full cursor-pointer border border-gray-700 hover:bg-[#222] transition-colors disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      <ShinyText text={isSending ? "Sending..." : "Send"} disabled={false} speed={3} className="custom-class" />
                    </button>
                  </div>
                  {contactStatus && (
                    <p className="text-center text-sm text-zinc-300">{contactStatus}</p>
                  )}
                </div>
              </form>
            </div>
