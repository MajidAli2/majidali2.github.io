    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-0">
          <a href="https://github.com/MajidAli2" aria-label="GitHub">
            <i className="ri-github-fill ri-2x"></i>
          </a>
          <a href="https://www.linkedin.com/in/majid-ali-28755738a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" aria-label="LinkedIn">
